...
homeArticleListDataFromJson(HomeArticleListData data, Map<String, dynamic> json) {
	if (json['curPage'] != null) {
		data.curPage = json['curPage']?.toInt();
	}
	if (json['datas'] != null) {
		data.datas = new List<HomeArticleListDataData>();
		(json['datas'] as List).forEach((v) {
			data.datas.add(new HomeArticleListDataData().fromJson(v));
		});
	}
	if (json['offset'] != null) {
...
homeArticleListDataDataFromJson(HomeArticleListDataData data, Map<String, dynamic> json) {
...
Map<String, dynamic> homeArticleListDataDataToJson(HomeArticleListDataData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
