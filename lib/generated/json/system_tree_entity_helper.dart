...
systemTreeEntityFromJson(SystemTreeEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new List<SystemTreeData>();
...
systemTreeDataFromJson(SystemTreeData data, Map<String, dynamic> json) {
	if (json['children'] != null) {
		data.children = new List<SystemTreeDataChild>();
...
systemTreeDataChildFromJson(SystemTreeDataChild data, Map<String, dynamic> json) {
	if (json['children'] != null) {
...
Map<String, dynamic> systemTreeDataChildToJson(SystemTreeDataChild entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	if (entity.children != null) {
		data['children'] =  [];
	}
