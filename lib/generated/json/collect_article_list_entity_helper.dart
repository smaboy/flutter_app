...
collectArticleListEntityFromJson(
    CollectArticleListEntity data, Map<String, dynamic> json) {
  if (json['data'] != null) {
...
collectArticleListDataFromJson(
    CollectArticleListData data, Map<String, dynamic> json) {
...
collectArticleListDataDataFromJson(
    CollectArticleListDataData data, Map<String, dynamic> json) {
  if (json['author'] != null) {
...
Map<String, dynamic> collectArticleListDataDataToJson(
    CollectArticleListDataData entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
