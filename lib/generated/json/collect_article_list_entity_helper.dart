...
collectArticleListEntityFromJson(CollectArticleListEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new CollectArticleListData().fromJson(json['data']);
	}
...
Map<String, dynamic> collectArticleListEntityToJson(CollectArticleListEntity entity) {
...
collectArticleListDataFromJson(CollectArticleListData data, Map<String, dynamic> json) {
	if (json['curPage'] != null) {
		data.curPage = json['curPage']?.toInt();
	}
	if (json['datas'] != null) {
		data.datas = new List<CollectArticleListDataData>();
...
Map<String, dynamic> collectArticleListDataToJson(CollectArticleListData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
collectArticleListDataDataFromJson(CollectArticleListDataData data, Map<String, dynamic> json) {
	if (json['author'] != null) {
...
Map<String, dynamic> collectArticleListDataDataToJson(CollectArticleListDataData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
