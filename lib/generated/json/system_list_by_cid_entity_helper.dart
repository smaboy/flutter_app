...
systemListByCidEntityFromJson(SystemListByCidEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new SystemListByCidData().fromJson(json['data']);
	}
...
systemListByCidDataFromJson(SystemListByCidData data, Map<String, dynamic> json) {
	if (json['curPage'] != null) {
		data.curPage = json['curPage']?.toInt();
	}
	if (json['datas'] != null) {
		data.datas = new List<SystemListByCidDataData>();
...
Map<String, dynamic> systemListByCidDataToJson(SystemListByCidData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
systemListByCidDataDataFromJson(SystemListByCidDataData data, Map<String, dynamic> json) {
...
Map<String, dynamic> systemListByCidDataDataToJson(SystemListByCidDataData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
