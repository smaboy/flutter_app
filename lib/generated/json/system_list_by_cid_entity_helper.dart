...
systemListByCidEntityFromJson(
    SystemListByCidEntity data, Map<String, dynamic> json) {
  if (json['data'] != null) {
...
systemListByCidDataFromJson(
    SystemListByCidData data, Map<String, dynamic> json) {
...
systemListByCidDataDataFromJson(
    SystemListByCidDataData data, Map<String, dynamic> json) {
...
Map<String, dynamic> systemListByCidDataDataToJson(
    SystemListByCidDataData entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
